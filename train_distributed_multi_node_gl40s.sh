...
n_epochs=20
exp_name="stephenvoltage_if_61_bs_2_2_phase_cond_l107l203"
...
python -m torch.distributed.launch --nproc_per_node=8 --nnodes=2 --node_rank=$SLURM_NODEID --master_addr=$MASTER_ADDR --master_port=$MASTER_PORT \

...
def parse_arguments(args=None):
    ...
    parser.add_argument(
        ...
        type=str,
        default="raw",
        help="key to specify which dataset to use from the zarr file (default: 'raw')",
    )
    ...
    parser.add_argument(
        "--prevent_injection",
        action="store_true",
        help="Whether to prevent injection of data back into network during training. If True will prevent the injection of input back into the model during training",
        default=False,
    )
